...
import com.katomegumi.zxpicture.interfaces.assembler.PictureAssembler;
...
import com.katomegumi.zxpicture.shared.auth.annotation.SaSpaceCheckPermission;
import com.katomegumi.zxpicture.shared.auth.model.SpaceUserPermissionConstant;
...
import com.katomegumi.zxpicture.interfaces.vo.picture.PictureTagCategory;
...
public class PictureController {
    ...
    public BaseResponse<Integer> uploadPictureByBatch(
        ...
        User loginUser = userApplicationService.getLoginUser(request);
        return ResultUtils.success(pictureApplicationService.uploadPictureByBatch(pictureUploadByBatchRequest,loginUser));
    }
    ...
    public BaseResponse<Boolean> doPictureReview(@RequestBody PictureReviewRequest pictureReviewRequest,
        ...
        pictureApplicationService.doPictureReview(pictureReviewRequest, user);
        return ResultUtils.success(true);
    }
    ...
    public BaseResponse<List<PictureVO>> searchPictureByPicColor(
        ...
        List<PictureVO> pictureVOList = pictureApplicationService.searchPictureByPicColor(spaceId, picColor, user);
